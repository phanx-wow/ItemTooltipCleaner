...
if GAME_LOCALE == "deDE" then
	...
	L.HIDE_FLAVOR_TRADE_TIP = "Anekdotentext auf Kräuter, Erze und anderen Handwerkswaren ausblenden, aber er auf anderen Gegenstände halten."
...
if GAME_LOCALE == "esES" or GAME_LOCALE == "esMX" then
	...
	L.HIDE_TAG = "\"%s\""
	L.HIDE_TRADE_FLAVOR = "Info en comerciables"
