...
L.HIDE_FLAVOR = "Hide flavor text"
...
L.HIDE_UNUSED = "Hide unused stats"
...
if GAME_LOCALE == "deDE" then
	...
	L.HIDE_FLAVOR = "Stiltext ausblenden"
	L.HIDE_FLAVOR_TIP = "Stiltext wird in Gelb mit Auführungszeichen angezeigt, und liefert Geschichtsinfo oder Witz."
	L.HIDE_FLAVOR_TRADE = "Nur auf Handwerkswaren"
	L.HIDE_FLAVOR_TRADE_TIP = "Stiltext auf Kräuter, Erze und anderen Handwerkswaren ausblenden, aber er auf anderen Gegenstände halten."
	...
	L.HIDE_UNUSED = "Unbenutzte Werte ausblenden"
...
--	L.HIDE_FLAVOR = "Hide flavor text"
--	L.HIDE_FLAVOR_TIP = "Flavor text is shown in yellow with quotation marks, and provides story background or humor."
	L.HIDE_FLAVOR_TRADE = "Sólo en objetos comerciables"
	L.HIDE_FLAVOR_TRADE_TIP = "Ocultar la información para principantes en hierbas, minerales y otros objetos comerciables, pero dejarlo en otros objetos."
	...
	L.HIDE_TRADE_FLAVOR = "Ocultar info en comerciables"
	L.HIDE_TRADE_FLAVOR_TIP = "Ocultar la información para principantes en hierbas, minerales y otros objetos comerciables."
	...
	L.HIDE_UNUSED = "Ocultar estadísticas sin usar"
...
--	L.HIDE_SETLIST = "Hide set item list"
	L.HIDE_TAG = "隐藏%q行"
--	L.HIDE_TRADE_FLAVOR = "Hide trade goods info"
--	L.HIDE_TRADE_FLAVOR_TIP = "Hides the newbie flavor text on herbs, ore and other trade goods."
